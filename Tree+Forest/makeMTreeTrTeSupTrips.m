function [ Sets , heights, triplets,SetsTest] = makeMTreeTrTeSupTrips( data,labels,inds, n0, h,dataTest,indsTest)
...
[S1,h1,tr1,S1Test] = makeMTreeTrTeSupTrips(data(S1,:),labels(S1),inds(S1),n0,h+1,dataTest(S1Test,:),indsTest(S1Test));
[S2,h2,tr2,S2Test] = makeMTreeTrTeSupTrips(data(S2,:),labels(S2),inds(S2),n0,h+1,dataTest(S2Test,:),indsTest(S2Test));
