function [ Sets , heights, triplets,SetsTest] = makeMTreeTrTeDis( Trdists,inds, n0, h,Tedists,indsTest)
...
[S1,h1,tr1,S1Test] = makeMTreeTrTeDis(Trdists(S1,S1),inds(S1),n0,h+1,Tedists(S1Test,S1),indsTest(S1Test));
[S2,h2,tr2,S2Test] = makeMTreeTrTeDis(Trdists(S2,S2),inds(S2),n0,h+1,Tedists(S2Test,S2),indsTest(S2Test));
